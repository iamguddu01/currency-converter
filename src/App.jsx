...
function App() {
  ...
  const allCurrencies = useCurrencyList();
  const options = allCurrencies.length > 0 ? allCurrencies : [];
  const swap = () => {
    setFrom(to)
    setTo(from)
    setResult(amount)
  ...
  return (
    <>
     <div
     className='flex flex-wrap justify-center items-center bg-no-repeat'
     style={{
